...
from .models import Achievement, meta_default_value, get_next_internal_id


class AchievementsBulkSerializer(serializers.ListSerializer):
    ...
    def create(self, validated_data):
        ...
        for item in validated_data:
            ...
            item.pop("meta")
            object_data.append(Achievement(meta=meta_data, **item))

        return Achievement.objects.bulk_create(object_data)
...
class AchievementSerializer(serializers.ModelSerializer):
    id = serializers.UUIDField(validators=[UniqueValidator(queryset=Achievement.objects.all())],
                               allow_null=True)
    ...
    def create(self, validated_data):
        ...
        instance = Achievement.objects.create(meta=meta_data, **validated_data)
    ...
    class Meta:
        ...
        list_serializer_class = AchievementsBulkSerializer
