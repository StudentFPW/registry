...
capitalized_app_name = "achievements".capitalize()


class BaseTestCase(APITestCase):
    @classmethod
    def setUpTestData(cls):
        cls.object1 = Achievement.objects.create(
            object_type='object',
            name='Object 1 Name',
            object_code='1',
        ...
        cls.object2 = Achievement.objects.create(
            object_type='object',
            name='Object 2 Name',
            object_code='2',
        ...
        cls.object3 = Achievement.objects.create(
        ...
        cls.object4 = Achievement.objects.create(
            object_type='different_object',
            name='Object 4 Name',
            object_code='4',
        ...
        cls.object5 = Achievement.objects.create(
            object_type='different_object',
            name='Object 4 Name',
            object_code='5',
            meta={'status': 'inactive', 'flags': 254},
        ...
        cls.object6 = Achievement.objects.create(
...
class GetAllObjectsTest(BaseTestCase):
    ...
    def test_get_all_objects(self):
        ...
        objects = Achievement.objects.all()
        serializer = AchievementSerializer(objects, many=True)
        self.assertEqual(response.data, serializer.data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)

    def test_get_objects_by_ids(self):
        id_str = ','.join([str(self.object1.id), str(self.object2.id)])
        url = f"/api/achievements/?id={id_str}"
        response = self.client.get(url)
    ...
    def test_get_objects_by_object_types(self):
        ...
        url = f"/api/achievements/?object_type={obj_types_str}"
        response = self.client.get(url)
    ...
    def test_get_objects_by_names(self):
        ...
        url = f"/api/achievements/?name={names_str}"
        response = self.client.get(url)
        self.assertEqual(len(response.data), 2)
    ...
    def test_get_objects_by_object_codes(self):
        ...
        url = f"/api/achievements/?object_code={obj_codes_str}"
        response = self.client.get(url)
        self.assertEqual(len(response.data), 2)
    ...
    def test_get_objects_by_project_ids(self):
        ...
        url = f"/api/achievements/?project_id={project_ids_str}"
        response = self.client.get(url)
    ...
    def test_get_objects_by_account_ids(self):
        ...
        url = f"/api/achievements/?account_id={account_ids_str}"
        response = self.client.get(url)
    ...
    def test_get_objects_by_user_ids(self):
        ...
        url = f"/api/achievements/?user_id={user_ids_str}"
        response = self.client.get(url)
        self.assertEqual(len(response.data), 2)
    ...
    def test_get_objects_by_object_items(self):
        ...
        url = f"/api/achievements/?object_item={object_items_str}"
        response = self.client.get(url)
        self.assertEqual(len(response.data), 4)
    ...
    def test_get_objects_by_data(self):
        ...
        self.assertEqual(len(response.data), 0)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        response = self.client.get('/api/achievements/?data=data 2__icontains=test data&'
                                   'data=data 1__exact=test data 1')
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        response = self.client.get('/api/achievements/?data=data 1__exact=test data 1&'
    ...
    def test_get_object_by_search_multiple_fields(self):
        url = ("/api/achievements/?search=1&field=name&field=data")
        response = self.client.get(url)
        self.assertEqual(len(response.data), 3)
...
class GetSingleObjectTest(BaseTestCase):
    ...
    def test_get_valid_single_object(self):
        model_name = 'Achievement'.lower()
        url = reverse(f"{model_name}-detail", kwargs={'pk': self.object1.id})
        response = self.client.get(url)
        obj = Achievement.objects.get(id=self.object1.id)
        serializer = AchievementSerializer(obj)
        self.assertEqual(response.data, serializer.data)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
...
class CreateSingleObjectTest(BaseTestCase):
    ...
    def test_create_valid_object(self):
        ...
        self.assertEqual(Achievement.objects.filter(name='Object 1 Name').count(), 2)
    ...
    def test_create_valid_object_with_passed_id(self):
        ...
        self.assertEqual(Achievement.objects.count(), 7)
        self.assertEqual(Achievement.objects.filter(name='Object 1 Name').count(), 2)
        obj = Achievement.objects.get(id="3fa85f64-5717-4562-b3fc-2c963f66afa6")
...
class CreateMultipleObjectsTest(APITestCase):
    ...
    def test_create_valid_objects_with_passed_id(self):
        ...
        self.assertEqual(Achievement.objects.filter(id="3fa85f64-5717-4562-b3fc-2c963f66afa6").count(), 1)
        self.assertEqual(Achievement.objects.filter(id="3fa85f64-5717-4562-b3fc-2c963f66afa7").count(), 1)
...
class UpdateSingleObjectTest(BaseTestCase):
    ...
    def test_valid_update_single_object(self):
        ...
        obj = Achievement.objects.get(id=initial_id)
    ...
    def test_valid_update_single_object_with_passed_id(self):
        ...
        obj_new = Achievement.objects.get(id=new_id)
        ...
        obj_old = Achievement.objects.get(id=initial_id)
...
class UpdateMultipleObjectsTest(BaseTestCase):
    ...
    def test_valid_update_multiple_objects(self):
        ...
        obj2 = Achievement.objects.get(id=self.obj2_initial_id)
        obj3 = Achievement.objects.get(id=self.obj3_initial_id)
    ...
    def test_invalid_update_multiple_objects(self):
        ...
        obj1 = Achievement.objects.get(id=self.obj1_initial_id)
        obj2 = Achievement.objects.get(id=self.obj2_initial_id)
        obj3 = Achievement.objects.get(id=self.obj3_initial_id)
...
class PatchSingleObjectTest(BaseTestCase):
    ...
    def test_object_type_patch_single_object(self):
        ...
        obj = Achievement.objects.get(id=self.initial_id)
    ...
    def test_invalid_patch_single_object(self):
        ...
        obj2 = Achievement.objects.get(id=initial_id)
        self.assertEqual(obj2.name, "Object 2 Name")
    ...
    def test_id_and_object_code_patch_single_object(self):
        ...
        new_obj = Achievement.objects.get(id="3fa85f64-5717-4562-b3fc-2c963f66afa6")
        ...
        old_obj = Achievement.objects.get(id=self.initial_id)
...
class DeleteSingleObjectTest(BaseTestCase):
    ...
    def test_valid_delete_single_object(self):
        ...
        obj = Achievement.objects.get(id=initial_id)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data['message'], 'Achievement deactivated')
...
class DeleteMultipleObjectsTest(BaseTestCase):
    ...
    def test_incomplete_delete_multiple_objects(self):
        ...
        response = self.client.delete(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data['message'], '2 achievements deactivated out of 3. '
...
class MetaFieldCreateSingleTest(BaseTestCase):
    ...
    def test_meta_create_single_object(self):
        ...
        self.assertEqual(Achievement.objects.filter(name='Object 1 Name').count(), 3)
        data = payloads.meta_payload_2
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.data['meta'],
                         {'status': 'inactive', 'flags': 0, 'internal_id': 9})
        self.assertEqual(Achievement.objects.filter(name='Object 1 Name').count(), 4)
        data = payloads.meta_payload_3
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.data['meta'],
                         {'status': 'active', 'flags': 116, 'internal_id': 10})
        self.assertEqual(Achievement.objects.filter(name='Object 1 Name').count(), 5)
        data = payloads.meta_payload_4
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.data['meta'],
                         {'status': 'active', 'flags': 0, 'internal_id': 11})
        self.assertEqual(Achievement.objects.filter(name='Object 1 Name').count(), 6)
        data = payloads.single_null_object_code_payload
        self.client.post(url, data, format='json')
        self.assertEqual(Achievement.objects.filter(name='Object 1 Name').count(), 7)
        data = payloads.meta_payload_5
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.data['meta'],
                         {'status': 'active', 'flags': 0, 'internal_id': 13})
        self.assertEqual(Achievement.objects.filter(name='Object 1 Name').count(), 8)
...
class MetaFieldCreateMultipleTest(BaseTestCase):
    ...
    def test_meta_create_multiple_objects(self):
        ...
        response = self.client.post(url, data, format='json')
        self.assertEqual(Achievement.objects.count(), 13)
        self.assertEqual(response.data[0]['meta'],
                         {'status': 'active', 'flags': 0, 'internal_id': 12})
        self.assertEqual(response.data[1]['meta'],
                         {'status': 'active', 'flags': 0, 'internal_id': 13})
