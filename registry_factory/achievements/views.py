...
from .filters import AchievementFilter, DynamicSearchFilter, CustomizedOrdering


@extend_schema(tags=['Achievements controllers'])
class AchievementsViewset(mixins.ListModelMixin,
    ...
    @extend_schema(
        ...
        examples=[
            OpenApiExample(
                ...
                value=achievements_list_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=achievements_bulk_create_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} bulk create response example',
                value=achievements_bulk_create_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=achievements_bulk_put_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} bulk put response example',
                value=achievements_bulk_put_response_example,
                response_only=True,
            )
        ]
    )
    def bulk_update(self, request, *args, **kwargs):
        ...
        instances = Achievement.objects.filter(id__in=ids).order_by('id')  # We only take instances that need to be updated
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=achievements_bulk_patch_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} bulk patch response example',
                value=achievements_bulk_patch_response_example,
                response_only=True,
            )
        ]
    )
    ...
    def bulk_deactivate(self, request, *args, **kwargs):
        ...
        objs = Achievement.objects.filter(id__in=id_list)
        ...
        if len(id_list) == len(objs):
            ...
            return Response(data={"message": f"{len(objs)} achievements deactivated out of {len(id_list)}. "
...
@extend_schema(tags=['Achievement controllers'])
class AchievementViewset(mixins.RetrieveModelMixin,
                          mixins.CreateModelMixin,
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=achievements_single_retrieve_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=achievements_single_put_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} single put response example',
                value=achievements_single_put_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @ extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=achievements_single_create_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} single create response example',
                value=achievements_single_create_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=achievements_single_patch_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} single patch response example',
                value=achievements_single_patch_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(responses={
            200: OpenApiResponse(
                inline_serializer(
                    name='AchievementDeactivatedResponse',
                    fields={
                        'message': serializers.CharField(default="Achievement deactivated"),
                    }
                ),
                description="Deactivated",
            )
    ...
    def deactivate(self, request, *args, **kwargs):
        ...
        instance.save()
        return Response(data={"message": "Achievement deactivated"},
                        status=status.HTTP_200_OK)
