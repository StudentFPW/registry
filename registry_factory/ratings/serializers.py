...
from .models import Rating, meta_default_value, get_next_internal_id


class RatingsBulkSerializer(serializers.ListSerializer):
    ...
    def create(self, validated_data):
        ...
        for item in validated_data:
            ...
            item.pop("meta")
            object_data.append(Rating(meta=meta_data, **item))

        return Rating.objects.bulk_create(object_data)
...
class RatingSerializer(serializers.ModelSerializer):
    id = serializers.UUIDField(validators=[UniqueValidator(queryset=Rating.objects.all())],
                               allow_null=True)
    ...
    def create(self, validated_data):
        ...
        instance = Rating.objects.create(meta=meta_data, **validated_data)
    ...
    class Meta:
        ...
        list_serializer_class = RatingsBulkSerializer
