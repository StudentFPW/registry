...
class BaseTestCase(APITestCase):
    ...
    def setUpTestData(cls):
        cls.object1 = Rating.objects.create(
            object_type='object',
            name='Object 1 Name',
            object_code='1',
        ...
        cls.object2 = Rating.objects.create(
            object_type='object',
            name='Object 2 Name',
            object_code='2',
        ...
        cls.object3 = Rating.objects.create(
        ...
        cls.object4 = Rating.objects.create(
            object_type='different_object',
            name='Object 4 Name',
            object_code='4',
        ...
        cls.object5 = Rating.objects.create(
            object_type='different_object',
            name='Object 4 Name',
            object_code='5',
            meta={'status': 'inactive', 'flags': 254},
        ...
        cls.object6 = Rating.objects.create(
...
class GetAllObjectsTest(BaseTestCase):
    ...
    def test_get_objects_by_object_types(self):
        ...
        url = f"/api/ratings/?object_type={obj_types_str}"
        response = self.client.get(url)
    ...
    def test_get_objects_by_names(self):
        ...
        url = f"/api/ratings/?name={names_str}"
        response = self.client.get(url)
        self.assertEqual(len(response.data), 2)
    ...
    def test_get_objects_by_object_codes(self):
        ...
        url = f"/api/ratings/?object_code={obj_codes_str}"
        response = self.client.get(url)
        self.assertEqual(len(response.data), 2)
    ...
    def test_get_objects_by_project_ids(self):
        ...
        url = f"/api/ratings/?project_id={project_ids_str}"
        response = self.client.get(url)
    ...
    def test_get_objects_by_account_ids(self):
        ...
        url = f"/api/ratings/?account_id={account_ids_str}"
        response = self.client.get(url)
    ...
    def test_get_objects_by_user_ids(self):
        ...
        url = f"/api/ratings/?user_id={user_ids_str}"
        response = self.client.get(url)
        self.assertEqual(len(response.data), 2)
    ...
    def test_get_objects_by_object_items(self):
        ...
        url = f"/api/ratings/?object_item={object_items_str}"
        response = self.client.get(url)
        self.assertEqual(len(response.data), 4)
    ...
    def test_get_objects_by_data(self):
        ...
        self.assertEqual(len(response.data), 0)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        response = self.client.get('/api/ratings/?data=data 2__icontains=test data&'
                                   'data=data 1__exact=test data 1')
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        response = self.client.get('/api/ratings/?data=data 1__exact=test data 1&'
    ...
    def test_get_object_by_search_multiple_fields(self):
        url = ("/api/ratings/?search=1&field=name&field=data")
        response = self.client.get(url)
        self.assertEqual(len(response.data), 3)
...
class GetSingleObjectTest(BaseTestCase):
    ...
    def test_get_valid_single_object(self):
        model_name = 'Rating'.lower()
        url = reverse(f"{model_name}-detail", kwargs={'pk': self.object1.id})
        response = self.client.get(url)
        obj = Rating.objects.get(id=self.object1.id)
...
class CreateSingleObjectTest(BaseTestCase):
    ...
    def test_create_valid_object(self):
        ...
        self.assertEqual(Rating.objects.filter(name='Object 1 Name').count(), 2)
    ...
    def test_create_invalid_object_item_object(self):
        ...
        self.assertEqual(Rating.objects.count(), 6)
    ...
    def test_create_valid_object_with_passed_id(self):
        ...
        self.assertEqual(Rating.objects.count(), 7)
        self.assertEqual(Rating.objects.filter(name='Object 1 Name').count(), 2)
        obj = Rating.objects.get(id="3fa85f64-5717-4562-b3fc-2c963f66afa6")
...
class CreateMultipleObjectsTest(APITestCase):
    ...
    def test_create_valid_objects_with_passed_id(self):
        ...
        self.assertEqual(Rating.objects.filter(id="3fa85f64-5717-4562-b3fc-2c963f66afa6").count(), 1)
        self.assertEqual(Rating.objects.filter(id="3fa85f64-5717-4562-b3fc-2c963f66afa7").count(), 1)
...
class UpdateSingleObjectTest(BaseTestCase):
    ...
    def test_valid_update_single_object(self):
        ...
        obj = Rating.objects.get(id=initial_id)
    ...
    def test_valid_update_single_object_with_passed_id(self):
        ...
        obj_new = Rating.objects.get(id=new_id)
        ...
        obj_old = Rating.objects.get(id=initial_id)
...
class UpdateMultipleObjectsTest(BaseTestCase):
    ...
    def test_valid_update_multiple_objects(self):
        ...
        obj2 = Rating.objects.get(id=self.obj2_initial_id)
        obj3 = Rating.objects.get(id=self.obj3_initial_id)
    ...
    def test_invalid_update_multiple_objects(self):
        ...
        obj1 = Rating.objects.get(id=self.obj1_initial_id)
        obj2 = Rating.objects.get(id=self.obj2_initial_id)
        obj3 = Rating.objects.get(id=self.obj3_initial_id)
...
class PatchSingleObjectTest(BaseTestCase):
    ...
    def test_object_type_patch_single_object(self):
        ...
        obj = Rating.objects.get(id=self.initial_id)
    ...
    def test_invalid_patch_single_object(self):
        ...
        obj2 = Rating.objects.get(id=initial_id)
        self.assertEqual(obj2.name, "Object 2 Name")
    ...
    def test_id_and_object_code_patch_single_object(self):
        ...
        new_obj = Rating.objects.get(id="3fa85f64-5717-4562-b3fc-2c963f66afa6")
        ...
        old_obj = Rating.objects.get(id=self.initial_id)
...
class DeleteSingleObjectTest(BaseTestCase):
    ...
    def test_valid_delete_single_object(self):
        ...
        obj = Rating.objects.get(id=initial_id)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data['message'], 'Rating deactivated')
...
class DeleteMultipleObjectsTest(BaseTestCase):
    ...
    def test_incomplete_delete_multiple_objects(self):
        ...
        response = self.client.delete(url)
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data['message'], '2 ratings deactivated out of 3. '
...
class MetaFieldCreateSingleTest(BaseTestCase):
    ...
    def test_meta_create_single_object(self):
        ...
        self.assertEqual(Rating.objects.filter(name='Object 1 Name').count(), 3)
        data = payloads.meta_payload_2
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.data['meta'],
                         {'status': 'inactive', 'flags': 0, 'internal_id': 9})
        self.assertEqual(Rating.objects.filter(name='Object 1 Name').count(), 4)
        data = payloads.meta_payload_3
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.data['meta'],
                         {'status': 'active', 'flags': 116, 'internal_id': 10})
        self.assertEqual(Rating.objects.filter(name='Object 1 Name').count(), 5)
        data = payloads.meta_payload_4
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.data['meta'],
                         {'status': 'active', 'flags': 0, 'internal_id': 11})
        self.assertEqual(Rating.objects.filter(name='Object 1 Name').count(), 6)
        data = payloads.single_null_object_code_payload
        self.client.post(url, data, format='json')
        self.assertEqual(Rating.objects.filter(name='Object 1 Name').count(), 7)
        data = payloads.meta_payload_5
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.data['meta'],
                         {'status': 'active', 'flags': 0, 'internal_id': 13})
        self.assertEqual(Rating.objects.filter(name='Object 1 Name').count(), 8)
...
class MetaFieldCreateMultipleTest(BaseTestCase):
    ...
    def test_meta_create_multiple_objects(self):
        ...
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(Rating.objects.count(), 11)
        self.assertEqual(response.data[0]['meta'],
                         {'status': 'inactive', 'flags': 0, 'internal_id': 9})
        self.assertEqual(response.data[1]['meta'],
                         {'status': 'active', 'flags': 116, 'internal_id': 10})
        ...
        response = self.client.post(url, data, format='json')
        self.assertEqual(Rating.objects.count(), 13)
        self.assertEqual(response.data[0]['meta'],
                         {'status': 'active', 'flags': 0, 'internal_id': 12})
        self.assertEqual(response.data[1]['meta'],
                         {'status': 'active', 'flags': 0, 'internal_id': 13})
