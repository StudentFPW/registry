...
from .models import Result, meta_default_value, get_next_internal_id


class ResultsBulkSerializer(serializers.ListSerializer):
    ...
    def create(self, validated_data):
        ...
        for item in validated_data:
            ...
            item.pop("meta")
            object_data.append(Result(meta=meta_data, **item))

        return Result.objects.bulk_create(object_data)
...
class ResultSerializer(serializers.ModelSerializer):
    id = serializers.UUIDField(validators=[UniqueValidator(queryset=Result.objects.all())],
                               allow_null=True)
    ...
    def create(self, validated_data):
        ...
        instance = Result.objects.create(meta=meta_data, **validated_data)
    ...
    class Meta:
        ...
        list_serializer_class = ResultsBulkSerializer
